...
const TOUR_SLIDES = [
  ...
  { icon: '🛍️',
    hi: { title: 'नई बिक्री दर्ज करें', body: 'नीचे गुलाबी + बटन दबाएँ। ग्राहक चुनें, राशि डालें — साड़ी की फ़ोटो भी ले सकती हैं। एक से ज़्यादा सामान बिका हो तो "और सामान जोड़ें" दबाकर सबको एक ही बिल में जोड़ सकती हैं। बाद में उस फ़ोटो पर टैप करने से कीमत और तारीख के साथ बड़ी दिखेगी।' },
    en: { title: 'Add a Sale', body: 'Tap the pink + button below. Pick the customer, enter the amount — you can even take a photo of the saree. Sold multiple items in one visit? Tap "Add another item" to put them all in one bill. Tap any photo later to see it enlarged with the price and date.' } },
  { icon: '💰',
