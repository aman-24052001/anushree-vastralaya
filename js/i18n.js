...
const L = {
  hi: {
    ...
    camUseGallery: '🖼️ गैलरी से चुनें', camPermDenied: 'कैमरा नहीं खुला — गैलरी से चुनें',
  ...
  en: {
    ...
    camUseGallery: '🖼️ Choose from Gallery', camPermDenied: 'Camera unavailable — pick from gallery',
